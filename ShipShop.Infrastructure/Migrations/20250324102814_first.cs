        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_LookupItems_CustomerStatusId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "ProductStatus", null },
                    { 2, true, "CustomerStatus", null },
                    { 3, true, "OrderStatus", null },
                    { 4, true, "CartStatus", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "LookupItems",
                columns: new[] { "Id", "IsActive", "LookupTypeId", "UpdatedOn", "Value" },
                values: new object[,]
                {
                    { 1, true, 1, null, "Available" },
                    { 2, true, 1, null, "Not Available" },
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "ConfirmPassword", "CustomerStatusId", "Email", "FirstName", "IsActive", "LastName", "Password", "RoleId", "UpdatedOn" },
                values: new object[] { 1, null, 3, "yasmeensaleh147@gmail.com", "Yasmeen", true, "Saleh", "yas12345", 1, null });
